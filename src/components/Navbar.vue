...
const currentFlag = ref('https://uxwing.com/wp-content/themes/uxwing/download/flags-landmarks/spain-country-flag-icon.png')
...
const toggleLanguage = () => {
  if (locale.value === 'es') {
    locale.value = 'en'
    currentFlag.value = 'https://cdn-icons-png.freepik.com/256/6737/6737832.png?semt=ais_hybrid'
  } else {
    locale.value = 'es'
    currentFlag.value = 'https://uxwing.com/wp-content/themes/uxwing/download/flags-landmarks/spain-country-flag-icon.png'
  }
}
</script>
        ...
        <div class="hidden sm:flex sm:items-center">
          <div class="flex items-center space-x-6">
            <div class="flex space-x-4">
              <router-link
                v-for="item in [{ name: t('navigation.home'), path: '/' }, { name: t('navigation.about'), path: '/about' }]"
                :key="item.name"
                :to="item.path"
            ...
            >
              ...
              <button @click="toggleLanguage" class="p-2 ml-4">
              <img :src="currentFlag" alt="Idioma" class="h-6 w-6" />
            </button>
